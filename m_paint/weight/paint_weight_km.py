...
def register():
    ...
    if kc:
        ...
        kmi.properties.name = "MXD_MT_PIE_PaintWeight_Brush"
        addon_keymaps.append((km, kmi))

        kmi = km.keymap_items.new('wm.call_menu_pie', 'F', 'PRESS', key_modifier='W')
        kmi.properties.name = "MXD_MT_PIE_PaintWeight_BrushFalloff"
        addon_keymaps.append((km, kmi))

        kmi = km.keymap_items.new('wm.call_menu_pie', 'C', 'PRESS')
        kmi.properties.name = "MXD_MT_PIE_PaintWeight_Toolbar"
        addon_keymaps.append((km, kmi))
